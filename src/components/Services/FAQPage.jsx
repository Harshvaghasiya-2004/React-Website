...
import { FaPlus, FaMinus, FaChevronLeft, FaChevronRight, FaEllipsisH } from 'react-icons/fa';
  ...
  const faqs = [
    {
      ...
      answer: "Cloud computing is categorized into three main types: Infrastructure as a Service (IaaS), Platform as a Service (PaaS), and Software as a Service (SaaS). IaaS provides virtualized computing resources, PaaS offers a platform for application development, and SaaS delivers software applications over the internet."
    },
    {
      question: "How secure is cloud computing?",
      answer: "Cloud providers implement strong security measures such as encryption, firewalls, and multi-factor authentication. However, businesses must also share responsibility by securing their data, managing access controls, and following best practices. Regular security audits, compliance certifications, and real-time monitoring enhance protection. Our solutions optimize every touchpoint of the customer journey, ensuring seamless, personalized, and meaningful interactions.",
      highlight: true
    },
    {
      question: "Can I move my existing business applications to the cloud?",
      answer: "Yes, most applications can be migrated to the cloud. The process involves assessment, planning, and execution. Some may require refactoring or re-platforming for optimal performance. Cloud providers offer tools and services to simplify migration."
    },
    {
      question: "How does cloud computing help businesses save costs?",
      answer: "Cloud computing eliminates upfront hardware costs and reduces maintenance expenses. You only pay for what you use (pay-as-you-go model). It also improves resource utilization, reduces downtime, and enables faster time-to-market."
    },
    {
      question: "How do you collect customer feedback?",
      answer: "We use multiple channels including surveys, in-app feedback, support tickets, and social media monitoring. All feedback is analyzed to identify trends and improvement areas. Regular reports are shared with clients to drive continuous enhancement."
    },
    {
      question: "How do I choose the right cloud service provider?",
      answer: "Consider factors like security certifications, compliance standards, scalability, pricing, support quality, and integration capabilities. Evaluate your business needs and conduct a proof-of-concept before committing."
    }
  ];
          ...
          {visibleFaqs.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className={`text-lg ${faq.highlight ? 'font-bold' : ''}`}>
                    {faq.question}
                  </span>
                  <motion.div
                  ...
                  >
                    {isOpen ? (
                      <FaMinus className={`w-5 h-5 ${faq.highlight ? 'text-black' : 'text-yellow-400'}`} />
                    ) : (
                      <FaPlus className={`w-5 h-5 ${faq.highlight ? 'text-black' : 'text-yellow-400'}`} />
                    )}
                  </motion.div>
                </button>
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className={`px-6 pb-5 text-sm leading-relaxed ${faq.highlight ? 'text-gray-800' : 'text-gray-300'}`}>
                        {faq.answer}
                      </div>
                    </motion.div>
                  )}
    ...
    {[...Array(totalPages)].map((_, i) => (
      <motion.div
        ...
        animate={{
          ...
          backgroundColor: currentPage === i + 1 ? "#FACC15" : "#374151",
        }}
